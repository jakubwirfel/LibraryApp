...
?>
<div>
<h6 class="display-4 my-3">Select article for modification</h6>
<form action="index.php?admin_panel&panel=modify_article" method="POST">
...
<form action="index.php?admin_panel&panel=modify_article" method="POST">
    <table class="table table-dark table-hover">
        ...
        <tr class="text-center user_row">
            ...
            <td><button onClick="javascript:window.open('http://127.0.0.1/LibraryApp/help_article_display.php?article=<?php echo $articleRow['article_id']?>','Windows','width=650,height=850,location=no,toolbar=no,menubar=no,scrollbars=yes,resizable=yes,location=no,directories=no,status=no');return false")" value="<?php echo $articleRow['article_id']?>" class="btn-md btn-danger"><i class="fas fa-eye"></i></button></td>
        </tr>
        <?php }?>
        </tbody>
    </table>
